        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            {productInfo.colors.map((color, index) => (
              <p
                key={index}
                className={`border border-black  rounded-lg px-2 py-1 cursor-pointer bg-${color.toLowerCase()}-400 ${
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            {productInfo.sizes.map((size, index) => (
              <p
                key={index}
                className={`border border-black  rounded-lg px-2 py-1 cursor-pointer  ${
